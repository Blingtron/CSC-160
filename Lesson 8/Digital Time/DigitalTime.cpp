...
DigitalTime::DigitalTime(int the_hour, int the_minute)
{
	...
	{
        throw DigitalTimeException(122,"Illegal argument to DigitalTime constructor.");
	}
	else
	{
		hour = the_hour;
...
void read_minute(istream& ins, int& the_minute)
{
	...
	{
        throw DigitalTimeException(404,"Error illegal input to read_minute\n");
	}
	...
	{
        throw DigitalTimeException(405,"Error illegal input to read_minute\n");
	}
}
...
void read_hour(istream& ins, int& the_hour)
{
	...
	{
        throw DigitalTimeException(406,"Error illegal input to read_hour\n");
	}
	...
	else //(isdigit(c1) && isdigit(c2))
	{
		...
		if (c2 != ':')
		{
            throw DigitalTimeException(407,"Error illegal input to read_hour\n");
		}
	}

	if ( the_hour < 0 || the_hour > 23 )
	{
        throw DigitalTimeException(408,"Error illegal input to read_hour\n");
	}
}
