...
int main()
{
    ...
    int test_amount;
    Movie mov1("Poopshit Fartman: The Crappening", Movie::R);
    Movie mov2("Sweaty Sanchez and the Little Tortilla Boy", Movie::PG13);
    Movie mov3("The Mummified Comfort Cat", Movie::G);
    Movie mov4("Backdoor Sluts 9", Movie::PG);
